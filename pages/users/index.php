        ...
        <div class="inputs-filter-container">
            <div class="form-row">
                ...
                <div class="input-group col-sm-1 " style="margin-bottom:1rem;">
                    <button type="button" title="Add New" class="material-icons btn btn-outline-primary my-2 my-sm-0" style="width:100%; text-align: center; vertical-align:middle;" onClick="location.href='?pr=Li9wYWdlcy91c2Vycy9mb3JtLnBocA=='">add_box</button>
                </div>
            </div>
