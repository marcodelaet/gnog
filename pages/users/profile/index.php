...
<div class="card bg-light mb-3 profile-card">
    ...
    <div class="card-body profile-body">
        ...
        <div class="profile-data">
            ...
            <spam id="card-email">email@dma.com</spam></div>
        <div class="profile-data"><spam class="material-icons icon-data">phone</spam><spam id="card-phone">+525599999999</spam></div>
