...
<script src="<?=$dir?>./assets/js/<?=strtolower($moduleName)?>.js" type="text/javascript"></script>
        ...
        <div class="inputs-filter-container">
            <div class="form-row">
                ...
                <div class="input-group col-sm-1 button-with-title" style="margin-bottom:1rem;">
                    <a type="button" title="Add New" class="btn btn-outline-primary my-2 my-sm-0" type="button" style="width:100%; text-align: center; vertical-align:middle;" onClick="location.href='?pr=<?=base64_encode('./pages/'.strtolower($moduleName).'s/form.php')?>'"><span class="material-icons">add_box</span><div class="text-button"><?=translateText('add+')?></div></a>
                </div>
                <!--<div class="input-group col-sm-1 button-with-title" style="margin-bottom:1rem;">
    ...
    <div class="<?=strtolower($moduleName)?>s-list">
        <table class="table table-hover table-sm">
            ...
            <thead>
                <tr>
                    <th scope="col"><?=translateText('product');?></th>
                    <th scope="col"><?=translateText('sale_model');?></th>
                    <th scope="col" style="text-align:center;"><?=ucfirst(translateText('is_digital'));?> / <?=ucfirst(translateText('is_not_digital'));?></th>
