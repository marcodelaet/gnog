                    ...
                    <div class="col">
                        ...
                        <div id="product-section">
                            <div id="product_0">
                                ...
                                <br/>
                                <div class="form-row">
                                    <div class="col-2 custom-control custom-switch" style="text-align:center; vertical-align:middle;" id="div-datetype-option">
                                        <input type="checkbox" class="custom-control-input" value="0" onchange="remakeDateField(this.value,this.id.substr(this.id.search('-')+1));" id="datetype_option" name="datetype_option" />
                                        <label class="custom-control-label" for="datetype_option"><?=ucfirst(translateText('unique_date'));?></label>
                                    </div>
                                    <div class="dateInputFixedW" id="div-startDate-product">
                                        <label id="label-start_date_product" for="start_date_product"><?=translateText('start_date');?></label>
                                        <input
                                        required
                                ...
                                <div class="form-row">
                                    <div class="col-2" id="div-selectproduct">
                                    ...
                                    <div class="col" id="div-selectsalemodel" >
                                        ...
                                        <spam id="ssalemodel">
                                            <select name="salemodel_id" id="selectsalemodel" title="salemodel_id" class="form-control" autocomplete="salemodel_id" >
