...
<script src="<?=$dir?>./assets/js/<?=strtolower($moduleName)?>.js" type="text/javascript"></script>
    ...
    <div class="filter-container" style="margin-bottom:1rem;">
        ...
        <div class="inputs-filter-container">
            <div class="form-row">
                ...
                <div class="input-group col-sm-1 button-with-title" style="margin-bottom:1rem;">
                    <a type="button" title="Import <?=ucfirst(translateText(strtolower($moduleName)))?>s from CSV file" class="btn btn-outline-primary my-2 my-sm-0" type="button" style="width:100%; text-align: center; vertical-align:middle;" onClick="location.href='?pr=<?=base64_encode('./pages/'.strtolower($moduleName).'s/formcsv.php')?>'"><span class="material-icons-outlined">file_upload</span><div class="text-button">CSV</div></a>
                </div>
            </div>
    ...
    <div class="<?=strtolower($moduleName)?>s-list">
        <table class="table table-hover table-sm">
            <caption>List of <?=ucfirst(translateText(strtolower($moduleName)))?>s</caption>
            <thead>
                <tr>
                    <th scope="col"><?=ucfirst(translateText('corporate_name'))?></th>
                    <th scope="col">&nbsp;</th>
                    <th scope="col">&nbsp;</th>
